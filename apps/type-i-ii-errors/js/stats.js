/**
 * Statistical functions for the Type I / Type II errors module.
 * All functions are pure — no DOM or global state.
 * (Mirrors apps/p-value-power/js/stats.js so this module is self-contained.)
 */
...
const Stats = (() => {
    ...
    /** Two-sided p-value from pre-generated arm event counts. */
    ...
    /** Generate n Bernoulli outcomes with probability p. Returns array of 0/1. */
